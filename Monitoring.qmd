...
The **counting is done by DAC (Data Assembly Center)**. There are **11 DACs worldwide** that process Argo float data and distribute it to the **GDAC (Global Data Assembly Centre)**.  
