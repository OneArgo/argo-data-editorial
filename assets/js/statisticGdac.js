$(function () {
	...
	$.getJSON("/docs/json/histogram_gdac.json", function(data) {
		var series = [];
		var series_all_axes = [];
		//Tri des données
	...
	$.getJSON("/docs/json/histogram_gdac_delayed.json", function(data) {
		var series = [];
	...
	$.getJSON("/docs/json/platform_pie.json", function(data) {
		var donnee = [];
