...
>The goal is to **publish a Jupyter-book starting from a project that doesn’t yet exist**. We’ll go through how to get a **Jupyter book template**, **create a personal GitLab project**, add this new book to your GitLab project, and **publish** **it**.
...
The first step before pull the Jupyter book template is to **create a new personnal gitlab project**.
...
### Clone the Jupyter book template
...
```{python}
#| eval: false
git clone https://gitlab.ifremer.fr/dev-ops/templates/project/docs-jupyterbook.git
```
...
Once we have changed our target URL, we need to **create a branch** to add the content of the Jupyter book template to our remote project. To do this, we should use the following command:
...
![](../../assets/images/img_jupyter/Capture%20d%E2%80%99%C3%A9cran%20du%202024-10-28%2016-47-27.png)
