...
# The Argo Vocabulary and Format Task Team (AVFTT)
The Argo NVS collections are overseen by a sub-group of the Argo Data Management Team called the Argo Vocabulary and Format Task Team (AVFTT, formerly AVTT). Each AVFTT member is responsible for a subset of Argo tables/collections, based on their interest and contributions. AVFTT members are the Editors of the tables/collections, in charge of making appropriate changes on the NVS on behalf of the Argo community.

The work of the AVFTT is currently co-chaired by Victor Turpin and Delphine Dobler and managed in the ArgoVocab repository of the OneArgo github: [https://github.com/OneArgo/ArgoVocabs](https://github.com/OneArgo/ArgoVocabs). 

The AVFTT meets several times per year in between annual ADMT meetings, to discuss requests from the Argo community for the evolution of Argo vocabularies.
...
If you need help or have questions about this process, please contact Delphine Dobler or Victor Turpin, co-chairs of the AVFTT.
