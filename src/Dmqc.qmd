...
- the GitHub repository for OWC:
    - Matlab version: [https://github.com/ArgoDMQC/matlab_owc](https://github.com/ArgoDMQC/matlab_owc){target="_blank"}
    - Python version: [https://github.com/euroargodev/argodmqc_owc](https://github.com/euroargodev/argodmqc_owc){target="_blank"}
...
- Argo Canada's BGC DMQC python package: [https://github.com/ArgoCanada/bgcArgoDMQC](https://github.com/ArgoCanada/bgcArgoDMQC){target="_blank"}
- Deep DMQC tools, including Deep CTD selection and DM_cpcor, both available from [https://github.com/ArgoDMQC/Deep_Argo_DMTools](https://github.com/ArgoDMQC/Deep_Argo_DMTools){target="_blank"}
- DM_FILLER, written in R, to fill BD files with adjustments: [https://github.com/catsch/DM_FILLER](https://github.com/catsch/DM_FILLER){target="_blank"}
- LOCODOX: [https://github.com/euroargodev/LOCODOX](https://github.com/euroargodev/LOCODOX){target="_blank"}
- RBRargo_DMQC routines: [https://github.com/ArgoDMQC/RBRargo_DMQC](https://github.com/euroargodev/LOCODOX){target="_blank"}

## DMQC meetings
Virtual DMQC meetings are organised by CSIRO every 2 months. These informal meetings are open to everyone. More information: [https://www.marine.csiro.au/argo/dmqc/html/ArgoDM-Disc.html](https://www.marine.csiro.au/argo/dmqc/html/ArgoDM-Disc.html){target="_blank"} 
